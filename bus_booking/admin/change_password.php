<?php 
	...
	$loadData = mysqli_query($connect, "SELECT * FROM `admin` WHERE email='".$_SESSION['email']."'");
	...
	if(isset($_POST['Update_password'])){
		...
		$Update_password = mysqli_query($connect, "UPDATE `admin` SET password='".md5($password)."' WHERE email='".$_SESSION['email']."' ");
		if($Update_password){
